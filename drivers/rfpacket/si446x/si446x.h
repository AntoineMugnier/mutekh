...
enum si446x_state_s
{
  ...
  SI446X_STATE_SLEEP,
  SI446X_STATE_AWAKING,                 /* 2*/
  SI446X_STATE_READY,
  SI446X_STATE_CONFIG,
  SI446X_STATE_CONFIG_RXC,
  SI446X_STATE_CONFIG_RXC_PENDING_STOP, /* 6 */
  SI446X_STATE_RX,
  SI446X_STATE_RXC,
  SI446X_STATE_RXC_JAMMING,             /* 9 */
...
#define SI446X_CHIP_INFO        (0x614400 | CONFIG_DRIVER_RFPACKET_SI446X_CHIPREV)
