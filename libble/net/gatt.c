...
static void ble_gatt_context_changed(struct net_layer_s *layer)
{
  ...
  logk_trace("client layer now %s", gatt->client.encrypted ? "encrypted" : "clear text");
