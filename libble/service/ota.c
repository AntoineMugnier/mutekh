...
BLE_GATT_SERVICE_DECL(ota_service, 1, BLE_UUID_BT_BASED_P(BLE_GATT_SERVICE_HUMAN_INTERFACE_DEVICE),
                      [CHAR_ID_REPORT_MAP] = BLE_GATT_CHAR_CONSTANT_BLOB(BLE_UUID_BT_BASED_P(BLE_GATT_CHAR_REPORT_MAP),
                                                                         report_map,
                                                                         sizeof(report_map)),

                      [CHAR_ID_ACTUATOR] = BLE_GATT_CHAR(BLE_UUID_BT_BASED_P(BLE_GATT_CHAR_REPORT),
                      ...
                      [CHAR_ID_MOTION] = BLE_GATT_CHAR(BLE_UUID_BT_BASED_P(BLE_GATT_CHAR_REPORT),
                                                       BLE_GATT_NOTIFIABLE | BLE_GATT_PERM_ENC_READ,
                      ...
                      [CHAR_ID_VIBRATOR] = BLE_GATT_CHAR(BLE_UUID_BT_BASED_P(BLE_GATT_CHAR_REPORT),
                      ...
                      [CHAR_ID_BATTERY] = BLE_GATT_CHAR(BLE_UUID_BT_BASED_P(BLE_GATT_CHAR_REPORT),
                                                        BLE_GATT_NOTIFIABLE | BLE_GATT_PERM_ENC_READ,
