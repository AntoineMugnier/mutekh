...
struct config_store_s;

error_t ble_gatt_client_state_save(struct ble_gatt_client_s *client,
                                   struct config_store_s *store);

error_t ble_gatt_client_state_restore(struct ble_gatt_client_s *client,
                                      struct config_store_s *store);
