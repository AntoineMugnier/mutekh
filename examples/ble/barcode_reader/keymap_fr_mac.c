...
const uint16_t keymap_fr_mac[128] = {
  ['\t'] = HID_KBD_TAB,
  ['\n'] = HID_KBD_ENTER,
  [' '] = HID_KBD_SPACEBAR,

  ['@'] = HID_KBD_NON_US_BACKSLASH,
  ['&'] = HID_KBD_1,
  //[''] = HID_KBD_2,
  ['"'] = HID_KBD_3,
  ['\''] = HID_KBD_4,
  ...
  ['#'] = MOD_SHIFT | HID_KBD_NON_US_BACKSLASH,
  ...
  ['_'] = MOD_SHIFT | HID_KBD_EQUAL_PLUS,

  ['\\'] = MOD_LALT | MOD_SHIFT | HID_KBD_PERIOD,
  ['['] = MOD_LALT | MOD_SHIFT | HID_KBD_5,
  [']'] = MOD_LALT | MOD_SHIFT | HID_KBD_MINUS_UNDERSCORE,
  ['{'] = MOD_LALT | HID_KBD_5,
  ['}'] = MOD_LALT | HID_KBD_MINUS_UNDERSCORE,
  ['|'] = MOD_LALT | MOD_SHIFT | HID_KBD_L,
  ['~'] = MOD_DEAD | MOD_LALT | HID_KBD_N,
  ...
  ['o'] = HID_KBD_O,
  ['p'] = HID_KBD_P,
  ['^'] = MOD_DEAD | HID_KBD_OPEN_BRACKET,
  ['$'] = MOD_DEAD | HID_KBD_CLOSE_BRACKET,
