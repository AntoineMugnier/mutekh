...
const uint16_t keymap_us[128] = {
  ...
  ['('] = MOD_SHIFT | HID_KBD_9,
  [')'] = MOD_SHIFT | HID_KBD_0,
  ['_'] = MOD_SHIFT | HID_KBD_MINUS_UNDERSCORE,
  ...
  ['Q'] = MOD_SHIFT | HID_KBD_Q,
  ['W'] = MOD_SHIFT | HID_KBD_W,
