...
BLE_GATTDB_SERVICE_DECL(dis_service,
                        ...
                        NULL,
                        BLE_GATTDB_CHAR_CONSTANT_STRING(BLE_UUID_SHORT_P(BLE_UUID_MANUFACTURER_NAME_STRING_CHAR),
                                                        "MutekH"),
                        BLE_GATTDB_CHAR_CONSTANT_STRING(BLE_UUID_SHORT_P(BLE_UUID_MODEL_NUMBER_STRING_CHAR),
                                                        "BLE Midi device"),
                        );
