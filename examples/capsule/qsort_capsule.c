...
#define CONTAINER_LOCK_qsort_param_queue HEXO_LOCK
...
GCT_CONTAINER_TYPES(qsort_param_queue, SLIST, struct qsort_param_s, list_entry);
GCT_CONTAINER_FCNS(qsort_param_queue, SLIST, static inline, qsort_param_queue, list_entry);
