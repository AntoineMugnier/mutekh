...
void main()
{
  ...
  if (device_get_accessor_by_path(&pwm, 0, "/pwm3", DRIVER_CLASS_PWM))
    {
  ...
  if (DEVICE_OP(&pwm, polarity, 0, &pol))
    {
  ...
  if (DEVICE_OP(&pwm, start_stop, 0 /* channel */, 1 /* start */))
