...
#if defined( CONFIG_HEXO_MMU_PAGESIZE )
 #define MMU_PAGESIZE CONFIG_HEXO_MMU_PAGESIZE
#else
 #define MMU_PAGESIZE 4096ul
#endif
...
#define MMU_KERNEL_START_ADDR ( MMU_KERNEL_START_PDE * MMU_PAGESIZE * MMU_TABLE_ENTRY )
#define MMU_KERNEL_END_ADDR ( MMU_KERNEL_END_PDE * MMU_PAGESIZE * MMU_TABLE_ENTRY )

#define MMU_USER_START_PDE 0ul
#define MMU_USER_END_PDE 1024ul 

#define MMU_USER_START_ADDR ( MMU_USER_START_PDE * MMU_PAGESIZE * MMU_TABLE_ENTRY )
#define MMU_USER_END_ADDR ( MMU_USER_END_PDE * MMU_PAGESIZE * MMU_TABLE_ENTRY )

#define MMU_MIRROR_PDE 2044ul
#define MMU_MIRROR_ADDR ( MMU_MIRROR_PDE * MMU_PAGESIZE * MMU_TABLE_ENTRY )
