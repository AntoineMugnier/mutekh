...
#define STM32_GPIO_MODER_ADDR                        0x00000000
...
#define STM32_GPIO_OTYPER_ADDR                       0x00000004
#define STM32_GPIO_OTYPER_MASK                       0x0000ffff
  ...
  #define STM32_GPIO_OTYPER_OT_OPEN                0x00000001

#define STM32_GPIO_OSPEEDR_ADDR                      0x00000008
...
#define STM32_GPIO_PUPDR_ADDR                        0x0000000c
...
#define STM32_GPIO_IDR_ADDR                          0x00000010
...
#define STM32_GPIO_ODR_ADDR                          0x00000014
...
#define STM32_GPIO_BSRR_ADDR                         0x00000018
#define STM32_GPIO_BSRR_MASK                         0xffffffff
  ...
  #define STM32_GPIO_BSRR_BR(fidx)                 (0x00010000 << ((fidx)))
  #define STM32_GPIO_BSRR_BR_SET(fidx, x, v)       do { (x) = (((x) & ~(0x10000 << ((fidx)))) | ((v) << ((fidx) + 16))); } while(0)
  #define STM32_GPIO_BSRR_BR_GET(fidx, x)          (((x) >> ((fidx) + 16)) & 0x1)

#define STM32_GPIO_LCKR_ADDR                         0x0000001c
...
#define STM32_GPIO_AFRL_ADDR                         0x00000020
...
#define STM32_GPIO_AFRH_ADDR                         0x00000024
