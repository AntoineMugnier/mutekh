...
#define STM32_GPIO_CRL_ADDR(ridx)                    (0x00000000 + (ridx) * 1024)
#define STM32_GPIO_CRL_COUNT                         7
#define STM32_GPIO_CRL_MASK                          0xffffffff
  #define STM32_GPIO_CRL_MODE_MASK                 0x00000003
  #define STM32_GPIO_CRL_MODE_COUNT                8
  #define STM32_GPIO_CRL_MODE(fidx, v)             ((STM32_GPIO_CRL_MODE_##v) << ((fidx) * 4 + 0))
  #define STM32_GPIO_CRL_MODE_SET(fidx, x, v)      do { (x) = (((x) & ~(0x3 << ((fidx) * 4))) | ((STM32_GPIO_CRL_MODE_##v) << ((fidx) * 4 + 0))); } while(0)
  #define STM32_GPIO_CRL_MODE_GET(fidx, x)         (((x) >> ((fidx) * 4 + 0)) & 0x3)
  ...
  #define STM32_GPIO_CRL_CNF(fidx, v)              ((STM32_GPIO_CRL_CNF_##v) << ((fidx) * 4 + 2))
  #define STM32_GPIO_CRL_CNF_SET(fidx, x, v)       do { (x) = (((x) & ~(0xc << ((fidx) * 4))) | ((STM32_GPIO_CRL_CNF_##v) << ((fidx) * 4 + 2))); } while(0)
  #define STM32_GPIO_CRL_CNF_GET(fidx, x)          (((x) >> ((fidx) * 4 + 2)) & 0x3)
  ...
  #define STM32_GPIO_CRL_CNF_ALT_OPEN_DRAIN        0x00000003

#define STM32_GPIO_CRH_ADDR(ridx)                    (0x00000004 + (ridx) * 1024)
#define STM32_GPIO_CRH_COUNT                         7
#define STM32_GPIO_CRH_MASK                          0xffffffff
  #define STM32_GPIO_CRH_MODE_MASK                 0x00000003
  #define STM32_GPIO_CRH_MODE_COUNT                8
  #define STM32_GPIO_CRH_MODE(fidx, v)             ((STM32_GPIO_CRH_MODE_##v) << ((fidx) * 4 + 0))
  #define STM32_GPIO_CRH_MODE_SET(fidx, x, v)      do { (x) = (((x) & ~(0x3 << ((fidx) * 4))) | ((STM32_GPIO_CRH_MODE_##v) << ((fidx) * 4 + 0))); } while(0)
  #define STM32_GPIO_CRH_MODE_GET(fidx, x)         (((x) >> ((fidx) * 4 + 0)) & 0x3)
  ...
  #define STM32_GPIO_CRH_CNF(fidx, v)              ((STM32_GPIO_CRH_CNF_##v) << ((fidx) * 4 + 2))
  #define STM32_GPIO_CRH_CNF_SET(fidx, x, v)       do { (x) = (((x) & ~(0xc << ((fidx) * 4))) | ((STM32_GPIO_CRH_CNF_##v) << ((fidx) * 4 + 2))); } while(0)
  #define STM32_GPIO_CRH_CNF_GET(fidx, x)          (((x) >> ((fidx) * 4 + 2)) & 0x3)
...
#define STM32_GPIO_IDR_ADDR(ridx)                    (0x00000008 + (ridx) * 1024)
...
#define STM32_GPIO_IDR_MASK                          0x0000ffff
  ...
  #define STM32_GPIO_IDR_IRD_GET(fidx, x)          (((x) >> ((fidx) + 0)) & 0x1)

#define STM32_GPIO_ODR_ADDR(ridx)                    (0x0000000c + (ridx) * 1024)
#define STM32_GPIO_ODR_COUNT                         7
#define STM32_GPIO_ODR_MASK                          0x0000ffff
  #define STM32_GPIO_ODR_ODR_MASK                  0x00000001
  #define STM32_GPIO_ODR_ODR_COUNT                 16
  #define STM32_GPIO_ODR_ODR(fidx)                 (0x00000001 << ((fidx)))
  #define STM32_GPIO_ODR_ODR_SET(fidx, x, v)       do { (x) = (((x) & ~(0x1 << ((fidx)))) | ((v) << ((fidx) + 0))); } while(0)
  #define STM32_GPIO_ODR_ODR_GET(fidx, x)          (((x) >> ((fidx) + 0)) & 0x1)

#define STM32_GPIO_BSRR_ADDR(ridx)                   (0x00000010 + (ridx) * 1024)
...
#define STM32_GPIO_BRR_ADDR(ridx)                    (0x00000014 + (ridx) * 1024)
...
#define STM32_GPIO_LCKR_ADDR(ridx)                   (0x00000018 + (ridx) * 1024)
