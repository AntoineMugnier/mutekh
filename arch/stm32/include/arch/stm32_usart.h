...
#define STM32_USART_SR_ADDR                      0x00000000
#define STM32_USART_SR_MASK                      0x000003ff
  #define STM32_USART_SR_PE_MASK               0x00000001
  #define STM32_USART_SR_PE                    0x00000001
  #define STM32_USART_SR_PE_SET(x, v)          do { (x) = (((x) & ~0x1) | ((v) << 0)); } while(0)
  #define STM32_USART_SR_PE_GET(x)             (((x) >> 0) & 0x1)
  #define STM32_USART_SR_FE_MASK               0x00000001
  #define STM32_USART_SR_FE                    0x00000002
  #define STM32_USART_SR_FE_SET(x, v)          do { (x) = (((x) & ~0x2) | ((v) << 1)); } while(0)
  #define STM32_USART_SR_FE_GET(x)             (((x) >> 1) & 0x1)
  #define STM32_USART_SR_NF_MASK               0x00000001
  #define STM32_USART_SR_NF                    0x00000004
  #define STM32_USART_SR_NF_SET(x, v)          do { (x) = (((x) & ~0x4) | ((v) << 2)); } while(0)
  #define STM32_USART_SR_NF_GET(x)             (((x) >> 2) & 0x1)
  #define STM32_USART_SR_ORE_MASK              0x00000001
  #define STM32_USART_SR_ORE                   0x00000008
  #define STM32_USART_SR_ORE_SET(x, v)         do { (x) = (((x) & ~0x8) | ((v) << 3)); } while(0)
  #define STM32_USART_SR_ORE_GET(x)            (((x) >> 3) & 0x1)
  #define STM32_USART_SR_IDLE_MASK             0x00000001
  #define STM32_USART_SR_IDLE                  0x00000010
  #define STM32_USART_SR_IDLE_SET(x, v)        do { (x) = (((x) & ~0x10) | ((v) << 4)); } while(0)
  #define STM32_USART_SR_IDLE_GET(x)           (((x) >> 4) & 0x1)
  #define STM32_USART_SR_RXNE_MASK             0x00000001
  #define STM32_USART_SR_RXNE                  0x00000020
  #define STM32_USART_SR_RXNE_SET(x, v)        do { (x) = (((x) & ~0x20) | ((v) << 5)); } while(0)
  #define STM32_USART_SR_RXNE_GET(x)           (((x) >> 5) & 0x1)
  #define STM32_USART_SR_TC_MASK               0x00000001
  #define STM32_USART_SR_TC                    0x00000040
  #define STM32_USART_SR_TC_SET(x, v)          do { (x) = (((x) & ~0x40) | ((v) << 6)); } while(0)
  #define STM32_USART_SR_TC_GET(x)             (((x) >> 6) & 0x1)
  #define STM32_USART_SR_TXE_MASK              0x00000001
  #define STM32_USART_SR_TXE                   0x00000080
  #define STM32_USART_SR_TXE_SET(x, v)         do { (x) = (((x) & ~0x80) | ((v) << 7)); } while(0)
  #define STM32_USART_SR_TXE_GET(x)            (((x) >> 7) & 0x1)
  #define STM32_USART_SR_LBD_MASK              0x00000001
  #define STM32_USART_SR_LBD                   0x00000100
  #define STM32_USART_SR_LBD_SET(x, v)         do { (x) = (((x) & ~0x100) | ((v) << 8)); } while(0)
  #define STM32_USART_SR_LBD_GET(x)            (((x) >> 8) & 0x1)
  #define STM32_USART_SR_CTS_MASK              0x00000001
  #define STM32_USART_SR_CTS                   0x00000200
  #define STM32_USART_SR_CTS_SET(x, v)         do { (x) = (((x) & ~0x200) | ((v) << 9)); } while(0)
  #define STM32_USART_SR_CTS_GET(x)            (((x) >> 9) & 0x1)

#define STM32_USART_DR_ADDR                      0x00000004
#define STM32_USART_DR_MASK                      0x000001ff
  #define STM32_USART_DR_DATA_MASK             0x000001ff
  #define STM32_USART_DR_DATA(v)               ((v) << 0)
  #define STM32_USART_DR_DATA_SET(x, v)        do { (x) = (((x) & ~0x1ff) | ((v) << 0)); } while(0)
  #define STM32_USART_DR_DATA_GET(x)           (((x) >> 0) & 0x1ff)

#define STM32_USART_BRR_ADDR                     0x00000008
#define STM32_USART_BRR_MASK                     0x0000ffff
  #define STM32_USART_BRR_FRAC_MASK            0x0000000f
  #define STM32_USART_BRR_FRAC(v)              ((v) << 0)
  #define STM32_USART_BRR_FRAC_SET(x, v)       do { (x) = (((x) & ~0xf) | ((v) << 0)); } while(0)
  #define STM32_USART_BRR_FRAC_GET(x)          (((x) >> 0) & 0xf)
  #define STM32_USART_BRR_MANT_MASK            0x00000fff
  #define STM32_USART_BRR_MANT(v)              ((v) << 4)
  #define STM32_USART_BRR_MANT_SET(x, v)       do { (x) = (((x) & ~0xfff0) | ((v) << 4)); } while(0)
  #define STM32_USART_BRR_MANT_GET(x)          (((x) >> 4) & 0xfff)

#define STM32_USART_CR1_ADDR                     0x0000000c
#define STM32_USART_CR1_MASK                     0x0000bfff
  #define STM32_USART_CR1_SBK_MASK             0x00000001
  #define STM32_USART_CR1_SBK                  0x00000001
  #define STM32_USART_CR1_SBK_SET(x, v)        do { (x) = (((x) & ~0x1) | ((v) << 0)); } while(0)
  #define STM32_USART_CR1_SBK_GET(x)           (((x) >> 0) & 0x1)
  #define STM32_USART_CR1_RWU_MASK             0x00000001
  #define STM32_USART_CR1_RWU                  0x00000002
  #define STM32_USART_CR1_RWU_SET(x, v)        do { (x) = (((x) & ~0x2) | ((v) << 1)); } while(0)
  #define STM32_USART_CR1_RWU_GET(x)           (((x) >> 1) & 0x1)
...
#define STM32_USART_CR2_MASK                     0x00007f6f
  #define STM32_USART_CR2_ADD_MASK             0x0000000f
  #define STM32_USART_CR2_ADD(v)               ((v) << 0)
  #define STM32_USART_CR2_ADD_SET(x, v)        do { (x) = (((x) & ~0xf) | ((v) << 0)); } while(0)
  #define STM32_USART_CR2_ADD_GET(x)           (((x) >> 0) & 0xf)
...
#define STM32_USART_CR3_ADDR                     0x00000014
#define STM32_USART_CR3_MASK                     0x000007ff
  ...
  #define STM32_USART_CR3_ONEBIT               0x00000400
  #define STM32_USART_CR3_ONEBIT_SET(x, v)     do { (x) = (((x) & ~0x400) | ((v) << 10)); } while(0)
  #define STM32_USART_CR3_ONEBIT_GET(x)        (((x) >> 10) & 0x1)

#define STM32_USART_GTPR_ADDR                    0x00000018
#define STM32_USART_GTPR_MASK                    0x0000ffff
