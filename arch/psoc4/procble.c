...
#define IDL 0b0001 // Mode 0, Idle: Sleep-unprecise ILO, IMO=16MHz
#define SLP 0b0010 // Mode 1, Sleep: Sleep-precise ILO, IMO=16MHz
#define PRE 0b0100 // Mode 2, Precise: Use ECO for HFCLK, HFCLK=24MHz
#define FUL 0b1000 // Mode 3, Full power: Max CPU speed
#define ALL 0b1111

DEV_DECLARE_STATIC(
  clock_dev, "clock", 0, psoc4_clock_drv,

  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_IMO, PSOC4_CLOCK_SRC_HFCLK, SLP|IDL|FUL, 1, 1),
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_ECO, PSOC4_CLOCK_SRC_HFCLK, PRE, 1, 1),
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_IMO, PSOC4_CLOCK_SRC_SYSCLK, ALL, 1, 1),
#if defined(CONFIG_DRIVER_PSOC4_CLOCK_BLE)
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_ECO, PSOC4_CLOCK_SRC_BLELL, ALL, 1, 1),
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_ILO, PSOC4_CLOCK_SRC_LFCLK, IDL, 1, 1),
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_WCO, PSOC4_CLOCK_SRC_LFCLK, SLP|PRE|FUL, 1, 1),
#else
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_ILO, PSOC4_CLOCK_SRC_LFCLK, ALL, 1, 1),
#endif
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_SRC_HFCLK, PSOC4_CLOCK_SRC_SYSCLK, ALL, 1, 1),

  DEV_STATIC_RES_CMU_OSC(PSOC4_CLOCK_OSC_IMO, FUL, 48000000, 1),
  DEV_STATIC_RES_CMU_OSC(PSOC4_CLOCK_OSC_IMO, SLP|PRE|IDL, 16000000, 1),
  ...
  DEV_STATIC_RES_CMU_OSC_ACC(PSOC4_CLOCK_OSC_WCO, ALL, 32768, 1, 2, 15), // 20ppm
#endif
...
DEV_DECLARE_STATIC(ble_dev, "ble", 0, psoc4_ble_drv,
                   ...
                   DEV_STATIC_RES_CLK_SRC("/clock", PSOC4_CLOCK_SRC_BLELL, PSOC4_BLE_CLK_SINK_LL),
                   DEV_STATIC_RES_CLOCK_MODES(PSOC4_BLE_CLK_SINK_LFCLK, 0, 1),
                   DEV_STATIC_RES_CLOCK_MODES(PSOC4_BLE_CLK_SINK_LL, 0, 1),
                   );
