...
# define BLE 0b0100 // Mode 2, BLE LL on: BLE-suitable WCO, IMO=16MHz
#else
# define BLE 0
#endif
#define FUL 0b1000 // Mode 3, Full power: BLE-suitable LFCLK, IMO=48MHz
...
DEV_DECLARE_STATIC(
...
#if defined(CONFIG_DRIVER_PSOC4_BLE)
  DEV_STATIC_RES_CLK_SRC("/ble", PSOC4_BLE_CLK_SRC_ECO, PSOC4_CLOCK_SINK_ECO),
  DEV_STATIC_RES_CLK_SRC("/ble", PSOC4_BLE_CLK_SRC_WCO, PSOC4_CLOCK_SINK_WCO),
#endif

  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_IMO, PSOC4_CLOCK_SRC_HFCLK, FUL|BLE|SLP|IDL, 1, 1),
#if defined(CONFIG_DRIVER_PSOC4_BLE)
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_OSC_ILO, PSOC4_CLOCK_SRC_LFCLK, SLP|IDL, 1, 1),
  DEV_STATIC_RES_CMU_MUX(PSOC4_CLOCK_SINK_WCO, PSOC4_CLOCK_SRC_LFCLK, BLE|FUL, 1, 1),
#else
  ...
  DEV_STATIC_RES_CMU_OSC(PSOC4_CLOCK_OSC_IMO, BLE|SLP|IDL, 16000000, 1),
