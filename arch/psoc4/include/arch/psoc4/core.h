...
/*
   bfgen -I core.bf -O core.h -o cdefs cdefs_use_reg_mask=1                    \
...
/** Current power mode of the device. Note that this field cannot be read in all
  ...
  #define SRSS_PWR_CONTROL_POWER_MODE(v)           ((v) << 0)
  #define SRSS_PWR_CONTROL_POWER_MODE_SET(x, v)    do { (x) = (((x) & ~0xf) | ((v) << 0)); } while(0)
...
/** ADFT mux select for Reference System characterization (engineering only).
  ...
  #define SRSS_PWR_BG_CONFIG_BG_DFT_VREF_SEL(v)    ((v) << 1)
  #define SRSS_PWR_BG_CONFIG_BG_DFT_VREF_SEL_SET(x, v) do { (x) = (((x) & ~0x1e) | ((v) << 1)); } while(0)
...
/** ADFT mux select for Bandgap characterization (engineering only). Selects
  ...
  #define SRSS_PWR_BG_CONFIG_BG_DFT_CORE_SEL(v)    ((v) << 5)
  #define SRSS_PWR_BG_CONFIG_BG_DFT_CORE_SEL_SET(x, v) do { (x) = (((x) & ~0x20) | ((v) << 5)); } while(0)
...
/** ADFT mux select for Bandgap characterization (engineering only). Selects a BG
  ...
  #define SRSS_PWR_BG_CONFIG_BG_DFT_ICORE_SEL(v)   ((v) << 6)
  #define SRSS_PWR_BG_CONFIG_BG_DFT_ICORE_SEL_SET(x, v) do { (x) = (((x) & ~0xc0) | ((v) << 6)); } while(0)
...
/** Enables SRSS.VREF[0] to 1.024V These references require 40us to settle after
   enabling them and 30us to settle after wakng from DeepSleep. @multiple */
  #define SRSS_PWR_BG_CONFIG_VREF_EN               0x00010000
/** Enables SRSS.VREF[1] to 1.024V These references require 40us to settle after
   enabling them and 30us to settle after wakng from DeepSleep. @multiple */
  #define SRSS_PWR_BG_CONFIG_VREF_EN               0x00020000
/** Enables SRSS.VREF[0] to 1.024V These references require 40us to settle after
   enabling them and 30us to settle after wakng from DeepSleep. @multiple */
  #define SRSS_PWR_BG_CONFIG_VREF_EN               0x00040000
...
/** Threshold selection for Low Voltage Detect circuit. Disable the LVD
  ...
  #define SRSS_PWR_VMON_CONFIG_LVD_SEL(v)          ((v) << 1)
  #define SRSS_PWR_VMON_CONFIG_LVD_SEL_SET(x, v)   do { (x) = (((x) & ~0x1e) | ((v) << 1)); } while(0)
...
/** DDFT mux select for HVPOR, PBOD, and LVD circuits (engineering only). Selects
  ...
  #define SRSS_PWR_VMON_CONFIG_VMON_DDFT_SEL(v)    ((v) << 5)
  #define SRSS_PWR_VMON_CONFIG_VMON_DDFT_SEL_SET(x, v) do { (x) = (((x) & ~0xe0) | ((v) << 5)); } while(0)
...
/** ADFT mux select for HVPOR, PBOD, and LVD circuits (engineering only). Selects
   a signal to output on adft_vmon @multiple */
  #define SRSS_PWR_VMON_CONFIG_VMON_ADFT_SEL(v)    ((v) << 8)
  #define SRSS_PWR_VMON_CONFIG_VMON_ADFT_SEL_SET(x, v) do { (x) = (((x) & ~0x300) | ((v) << 8)); } while(0)
...
/** Signal select for ddft1 output: @multiple */
  #define SRSS_PWR_DDFT_SELECT_DDFT1_SEL(v)        ((v) << 0)
  #define SRSS_PWR_DDFT_SELECT_DDFT1_SEL_SET(x, v) do { (x) = (((x) & ~0xf) | ((v) << 0)); } while(0)
...
/** Signal select for ddft2 output: @multiple */
  #define SRSS_PWR_DDFT_SELECT_DDFT2_SEL(v)        ((v) << 4)
  #define SRSS_PWR_DDFT_SELECT_DDFT2_SEL_SET(x, v) do { (x) = (((x) & ~0xf0) | ((v) << 4)); } while(0)
...
/** To detect brown-outs firmware should do this on boot: Read value, set value
  ...
  #define SRSS_PWR_BOD_KEY_KEY16(v)                ((v) << 0)
  #define SRSS_PWR_BOD_KEY_KEY16_SET(x, v)         do { (x) = (((x) & ~0xffff) | ((v) << 0)); } while(0)
...
/** This byte must be set to 0x3A for FREEZE or STOP fields to operate. Any other
  ...
  #define SRSS_PWR_STOP_UNLOCK(v)                  ((v) << 8)
  #define SRSS_PWR_STOP_UNLOCK_SET(x, v)           do { (x) = (((x) & ~0xff00) | ((v) << 8)); } while(0)
...
/** Selects a source for HFCLK (when HFCLK_SEL=0) and DSI_IN[0]. @multiple */
  #define SRSS_CLK_SELECT_DIRECT_SEL(v)            ((v) << 0)
  #define SRSS_CLK_SELECT_DIRECT_SEL_SET(x, v)     do { (x) = (((x) & ~0x7) | ((v) << 0)); } while(0)
...
/** Selects a source the input of EXCO PLL1, if supported. @multiple */
  #define SRSS_CLK_SELECT_DBL_SEL(v)               ((v) << 3)
  #define SRSS_CLK_SELECT_DBL_SEL_SET(x, v)        do { (x) = (((x) & ~0x38) | ((v) << 3)); } while(0)
...
/** Selects a source the input of EXCO PLL0, if supported. @multiple */
  #define SRSS_CLK_SELECT_PLL_SEL(v)               ((v) << 6)
  #define SRSS_CLK_SELECT_PLL_SEL_SET(x, v)        do { (x) = (((x) & ~0x1c0) | ((v) << 6)); } while(0)
...
/** Selects a source for the input of DPLL. Note that not all products support
  ...
  #define SRSS_CLK_SELECT_DPLLIN_SEL(v)            ((v) << 9)
  #define SRSS_CLK_SELECT_DPLLIN_SEL_SET(x, v)     do { (x) = (((x) & ~0xe00) | ((v) << 9)); } while(0)
...
/** Selects a source for the reference (tracking) input of DPLL: @multiple */
  #define SRSS_CLK_SELECT_DPLLREF_SEL(v)           ((v) << 12)
  #define SRSS_CLK_SELECT_DPLLREF_SEL_SET(x, v)    do { (x) = (((x) & ~0x3000) | ((v) << 12)); } while(0)
...
/** Prohibits writing to WDT_* registers and CLK_ILO register when not equal 0.
  ...
  #define SRSS_CLK_SELECT_WDT_LOCK(v)              ((v) << 14)
  #define SRSS_CLK_SELECT_WDT_LOCK_SET(x, v)       do { (x) = (((x) & ~0xc000) | ((v) << 14)); } while(0)
...
/** Selects the source for HFCLK. @multiple */
  #define SRSS_CLK_SELECT_HFCLK_SEL(v)             ((v) << 16)
  #define SRSS_CLK_SELECT_HFCLK_SEL_SET(x, v)      do { (x) = (((x) & ~0x30000) | ((v) << 16)); } while(0)
...
/** Power down mode. Note: this bit must always be set to 0 and never changed.
  ...
  #define SRSS_CLK_ILO_CONFIG_PD_MODE(v)           ((v) << 0)
  #define SRSS_CLK_ILO_CONFIG_PD_MODE_SET(x, v)    do { (x) = (((x) & ~0x1) | ((v) << 0)); } while(0)
...
/** PFET bias. Leave this bit at the default setting for normal operation.
  ...
  #define SRSS_CLK_ILO_CONFIG_SATBIAS(v)           ((v) << 2)
  #define SRSS_CLK_ILO_CONFIG_SATBIAS_SET(x, v)    do { (x) = (((x) & ~0x4) | ((v) << 2)); } while(0)
...
/** Selects operating source for SPCIF Timer/Flash Pump clock. @multiple */
  #define SRSS_CLK_IMO_CONFIG_FLASHPUMP_SEL(v)     ((v) << 22)
  #define SRSS_CLK_IMO_CONFIG_FLASHPUMP_SEL_SET(x, v) do { (x) = (((x) & ~0x400000) | ((v) << 22)); } while(0)
...
/** Selects operating source for Pump clock. This clock is not guaranteed to be
  ...
  #define SRSS_CLK_IMO_CONFIG_PUMP_SEL(v)          ((v) << 25)
  #define SRSS_CLK_IMO_CONFIG_PUMP_SEL_SET(x, v)   do { (x) = (((x) & ~0xe000000) | ((v) << 25)); } while(0)
...
/** Spread spectrum range (downspread when SS_VALUE=16). @multiple */
  #define SRSS_CLK_IMO_SPREAD_SS_RANGE(v)          ((v) << 28)
  #define SRSS_CLK_IMO_SPREAD_SS_RANGE_SET(x, v)   do { (x) = (((x) & ~0x30000000) | ((v) << 28)); } while(0)
...
/** Spread Spectrum Mode. @multiple */
  #define SRSS_CLK_IMO_SPREAD_SS_MODE(v)           ((v) << 30)
  #define SRSS_CLK_IMO_SPREAD_SS_MODE_SET(x, v)    do { (x) = (((x) & ~0xc0000000) | ((v) << 30)); } while(0)
...
/** Select signal for DFT output #1. @multiple */
  #define SRSS_CLK_DFT_SELECT_DFT_SEL1(v)          ((v) << 0)
  #define SRSS_CLK_DFT_SELECT_DFT_SEL1_SET(x, v)   do { (x) = (((x) & ~0xf) | ((v) << 0)); } while(0)
...
/** DFT Output Divide Down. @multiple */
  #define SRSS_CLK_DFT_SELECT_DFT_DIV1(v)          ((v) << 4)
  #define SRSS_CLK_DFT_SELECT_DFT_DIV1_SET(x, v)   do { (x) = (((x) & ~0x30) | ((v) << 4)); } while(0)
...
/** Select signal for DFT output #2. @multiple */
  #define SRSS_CLK_DFT_SELECT_DFT_SEL2(v)          ((v) << 8)
  #define SRSS_CLK_DFT_SELECT_DFT_SEL2_SET(x, v)   do { (x) = (((x) & ~0xf00) | ((v) << 8)); } while(0)
...
/** Watchdog Counter Action on Match (WDT_CTR0 = WDT_MATCH0). @multiple */
  #define SRSS_WDT_CONFIG_WDT_MODE0(v)             ((v) << 0)
  #define SRSS_WDT_CONFIG_WDT_MODE0_SET(x, v)      do { (x) = (((x) & ~0x3) | ((v) << 0)); } while(0)
...
/** Watchdog Counter Action on Match (WDT_CTR1 = WDT_MATCH1). @multiple */
  #define SRSS_WDT_CONFIG_WDT_MODE1(v)             ((v) << 8)
  #define SRSS_WDT_CONFIG_WDT_MODE1_SET(x, v)      do { (x) = (((x) & ~0x300) | ((v) << 8)); } while(0)
...
/** Select source for LFCLK. @multiple */
  #define SRSS_WDT_CONFIG_LFCLK_SEL(v)             ((v) << 30)
  #define SRSS_WDT_CONFIG_LFCLK_SEL_SET(x, v)      do { (x) = (((x) & ~0xc0000000) | ((v) << 30)); } while(0)
...
#define SRSS_PWR_BG_TRIM3_ADDR                       0x00000f18
...
#define SRSS_PWR_BG_TRIM4_ADDR                       0x00000f1c
...
#define SRSS_PWR_BG_TRIM5_ADDR                       0x00000f20
...
#define SRSS_CLK_ILO_TRIM_ADDR                       0x00000f24
...
/** Adjusts the bias in the event of high current after fab. Leave these bits at
  ...
  #define SRSS_CLK_ILO_TRIM_COARSE_TRIM_MODE(v)    ((v) << 7)
  #define SRSS_CLK_ILO_TRIM_COARSE_TRIM_MODE_SET(x, v) do { (x) = (((x) & ~0x80) | ((v) << 7)); } while(0)
...
#define SRSS_CLK_IMO_TRIM1_ADDR                      0x00000f28
...
#define SRSS_CLK_IMO_TRIM2_ADDR                      0x00000f2c
...
#define SRSS_CLK_IMO_TRIM4_ADDR                      0x00000f34
...
#define SRSS_PWR_RSVD_TRIM_ADDR                      0x00000f38
