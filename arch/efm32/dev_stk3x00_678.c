...
#if defined(CONFIG_DRIVER_EFM32_DMA)
  DEV_STATIC_RES_DMA("/dma", CONFIG_DRIVER_EFM32_DMA_CHANNEL_COUNT - 1, (EFM32_DMA_SOURCE_USART1 << 16) | EFM32_DMA_SIGNAL_USART1RXDATAV),
  DEV_STATIC_RES_DMA("/dma", CONFIG_DRIVER_EFM32_DMA_CHANNEL_COUNT - 2, (EFM32_DMA_SOURCE_USART1 << 16) | EFM32_DMA_SIGNAL_USART1TXEMPTY),
#endif
...
DEV_DECLARE_STATIC_RESOURCES(i2c_dev_res, 6,
    ...
    DEV_STATIC_RES_IRQ(0, EFM32_IRQ_I2C1, 0, "/cpu"),
    DEV_STATIC_RES_DEV_PARAM("iomux", "/gpio"),
...
DEV_DECLARE_STATIC(i2c_dev, "i2c1", 0, efm32_i2c_drv, &i2c_dev_res);
...
DEV_DECLARE_STATIC(pwm_dev, "pwm0", 0, efm32_pwm_drv, &pwm_dev_res);
