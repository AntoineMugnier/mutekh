...
void efm32_board_init()
{
  ...
  x = cpu_mem_read_32(gpio + EFM32_GPIO_MODEH_ADDR(3));
  EFM32_GPIO_MODEH_MODE_SET(5, x, PUSHPULL);
  cpu_mem_write_32(gpio + EFM32_GPIO_MODEH_ADDR(3), x);

  cpu_mem_write_32(gpio + EFM32_GPIO_DOUTSET_ADDR(3),
                   EFM32_GPIO_DOUTSET_DOUTSET(13));
#endif
}
