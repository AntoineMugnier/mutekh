...
# endif
                   ...
                   DEV_STATIC_RES_DMA((1 << 1), (EFM32_DMA_SOURCE_USART1 | (EFM32_DMA_SIGNAL_USARTRXDATAV << 8))),
                   DEV_STATIC_RES_DMA((1 << 2), (EFM32_DMA_SOURCE_USART1 | (EFM32_DMA_SIGNAL_USARTTXEMPTY << 8))),
#endif
