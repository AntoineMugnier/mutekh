...
/*
   bfgen -o cdefs cdefs_use_reg_mask=1 cdefs_use_field_setval=1                \
     -I /home/cerdan/Work/EFR32/bitfield/modified_bf/12/cmu.bf                 \
     -O arch/efm32/include/arch/efm32/efr/efr32_12/cmu.h
*/
...
#define EFM32_CMU_HFBUSCLKEN0_MASK                   0x0000007f
  #define EFM32_CMU_HFBUSCLKEN0_CRYPTO0            0x00000001
  #define EFM32_CMU_HFBUSCLKEN0_CRYPTO1            0x00000002
  #define EFM32_CMU_HFBUSCLKEN0_LE                 0x00000004
  #define EFM32_CMU_HFBUSCLKEN0_GPIO               0x00000008
  #define EFM32_CMU_HFBUSCLKEN0_PRS                0x00000010
  #define EFM32_CMU_HFBUSCLKEN0_LDMA               0x00000020
  #define EFM32_CMU_HFBUSCLKEN0_GPCRC              0x00000040

#define EFM32_CMU_HFPERCLKEN0_ADDR                   0x000000c0
#define EFM32_CMU_HFPERCLKEN0_MASK                   0x0007ffff
  ...
  #define EFM32_CMU_HFPERCLKEN0_WTIMER1            0x00000008
  #define EFM32_CMU_HFPERCLKEN0_USART0             0x00000010
  #define EFM32_CMU_HFPERCLKEN0_USART1             0x00000020
  #define EFM32_CMU_HFPERCLKEN0_USART2             0x00000040
  #define EFM32_CMU_HFPERCLKEN0_USART3             0x00000080
  #define EFM32_CMU_HFPERCLKEN0_I2C0               0x00000100
  #define EFM32_CMU_HFPERCLKEN0_I2C1               0x00000200
  #define EFM32_CMU_HFPERCLKEN0_ACMP0              0x00000400
  #define EFM32_CMU_HFPERCLKEN0_ACMP1              0x00000800
  #define EFM32_CMU_HFPERCLKEN0_CRYOTIMER          0x00001000
  #define EFM32_CMU_HFPERCLKEN0_ADC0               0x00002000
  #define EFM32_CMU_HFPERCLKEN0_IDAC0              0x00004000
  #define EFM32_CMU_HFPERCLKEN0_VDAC0              0x00008000
  #define EFM32_CMU_HFPERCLKEN0_CSEN               0x00010000
  #define EFM32_CMU_HFPERCLKEN0_TRNG0              0x00020000
  #define EFM32_CMU_HFPERCLKEN0_SYSCFG             0x00040000
...
#define EFM32_CMU_HFBUSCLKENMASK0_MASK               0x0001ffff
  #define EFM32_CMU_HFBUSCLKENMASK0_CRYPTO0        0x00000001
  #define EFM32_CMU_HFBUSCLKENMASK0_CRYPTO1        0x00000002
  #define EFM32_CMU_HFBUSCLKENMASK0_LE             0x00000004
  #define EFM32_CMU_HFBUSCLKENMASK0_GPIO           0x00000008
  #define EFM32_CMU_HFBUSCLKENMASK0_PRS            0x00000010
  #define EFM32_CMU_HFBUSCLKENMASK0_LDMA           0x00000020
  #define EFM32_CMU_HFBUSCLKENMASK0_GPCRC          0x00000040
  #define EFM32_CMU_HFBUSCLKENMASK0_DMEM0          0x00000080
  #define EFM32_CMU_HFBUSCLKENMASK0_DMEM1          0x00000100
  #define EFM32_CMU_HFBUSCLKENMASK0_DMEM2          0x00000200
  #define EFM32_CMU_HFBUSCLKENMASK0_BUSMATRIX      0x00000400
  #define EFM32_CMU_HFBUSCLKENMASK0_DMEMSEQ        0x00000800
  #define EFM32_CMU_HFBUSCLKENMASK0_AHB2APB0       0x00001000
  #define EFM32_CMU_HFBUSCLKENMASK0_CMCTRL_RSYNC_COMB 0x00002000
  #define EFM32_CMU_HFBUSCLKENMASK0_MSC            0x00004000
  #define EFM32_CMU_HFBUSCLKENMASK0_IMEM_FAST      0x00008000
  #define EFM32_CMU_HFBUSCLKENMASK0_SMU            0x00010000

#define EFM32_CMU_HFCORECLKENMASK0_ADDR              0x00000194
#define EFM32_CMU_HFCORECLKENMASK0_MASK              0x00000007
  #define EFM32_CMU_HFCORECLKENMASK0_CM4           0x00000001
  #define EFM32_CMU_HFCORECLKENMASK0_CM3_FREE      0x00000002
  #define EFM32_CMU_HFCORECLKENMASK0_CM3_FAST      0x00000004

#define EFM32_CMU_HFPERCLKENMASK0_ADDR               0x00000198
#define EFM32_CMU_HFPERCLKENMASK0_MASK               0x00ffffff
  #define EFM32_CMU_HFPERCLKENMASK0_TIMER0         0x00000001
  #define EFM32_CMU_HFPERCLKENMASK0_TIMER1         0x00000002
  #define EFM32_CMU_HFPERCLKENMASK0_WTIMER0        0x00000004
  #define EFM32_CMU_HFPERCLKENMASK0_WTIMER1        0x00000008
  #define EFM32_CMU_HFPERCLKENMASK0_USART0         0x00000010
  #define EFM32_CMU_HFPERCLKENMASK0_USART1         0x00000020
  #define EFM32_CMU_HFPERCLKENMASK0_USART2         0x00000040
  #define EFM32_CMU_HFPERCLKENMASK0_USART3         0x00000080
  #define EFM32_CMU_HFPERCLKENMASK0_I2C0           0x00000100
  #define EFM32_CMU_HFPERCLKENMASK0_I2C1           0x00000200
  #define EFM32_CMU_HFPERCLKENMASK0_ACMP0          0x00000400
  #define EFM32_CMU_HFPERCLKENMASK0_ACMP1          0x00000800
  #define EFM32_CMU_HFPERCLKENMASK0_CRYOTIMER      0x00001000
  #define EFM32_CMU_HFPERCLKENMASK0_ADC0           0x00002000
  #define EFM32_CMU_HFPERCLKENMASK0_IDAC0          0x00004000
  #define EFM32_CMU_HFPERCLKENMASK0_VDAC0          0x00008000
  #define EFM32_CMU_HFPERCLKENMASK0_CSEN           0x00010000
  #define EFM32_CMU_HFPERCLKENMASK0_TRNG0          0x00020000
  #define EFM32_CMU_HFPERCLKENMASK0_SYSCFG         0x00040000
  #define EFM32_CMU_HFPERCLKENMASK0_APB_RSYNC_COMB 0x00080000
  #define EFM32_CMU_HFPERCLKENMASK0_EMU            0x00100000
  #define EFM32_CMU_HFPERCLKENMASK0_RMU            0x00200000
  #define EFM32_CMU_HFPERCLKENMASK0_CMU            0x00400000
  #define EFM32_CMU_HFPERCLKENMASK0_APORT          0x00800000

#define EFM32_CMU_HFRADIOCLKENMASK0_ADDR             0x000001a4
#define EFM32_CMU_HFRADIOCLKENMASK0_MASK             0x000000ff
  ...
  #define EFM32_CMU_HFRADIOCLKENMASK0_CRC          0x00000010
  #define EFM32_CMU_HFRADIOCLKENMASK0_SYNTH        0x00000020
  #define EFM32_CMU_HFRADIOCLKENMASK0_MODEM        0x00000040
  #define EFM32_CMU_HFRADIOCLKENMASK0_AGC          0x00000080

#define EFM32_CMU_HFRADIOALTCLKENMASK0_ADDR          0x000001ac
#define EFM32_CMU_HFRADIOALTCLKENMASK0_MASK          0x00000001
  #define EFM32_CMU_HFRADIOALTCLKENMASK0_BUFC      0x00000001

#define EFM32_CMU_HFUNDIVCLKENMASK0_ADDR             0x000001b0
#define EFM32_CMU_HFUNDIVCLKENMASK0_MASK             0x00000007
  #define EFM32_CMU_HFUNDIVCLKENMASK0_SYNTH_HFXO   0x00000001
  #define EFM32_CMU_HFUNDIVCLKENMASK0_DEMOD_HFXO   0x00000002
  #define EFM32_CMU_HFUNDIVCLKENMASK0_AGC_HFXO     0x00000004

#define EFM32_CMU_LFACLKENMASK0_ADDR                 0x000001b4
#define EFM32_CMU_LFACLKENMASK0_MASK                 0x00000003
  #define EFM32_CMU_LFACLKENMASK0_LETIMER0         0x00000001
  #define EFM32_CMU_LFACLKENMASK0_LESENSE          0x00000002

#define EFM32_CMU_LFBCLKENMASK0_ADDR                 0x000001bc
#define EFM32_CMU_LFBCLKENMASK0_MASK                 0x00000007
  #define EFM32_CMU_LFBCLKENMASK0_SYSTICK          0x00000001
  #define EFM32_CMU_LFBCLKENMASK0_LEUART0          0x00000002
  #define EFM32_CMU_LFBCLKENMASK0_CSEN             0x00000004
...
#define EFM32_CMU_PCNTCLKENMASK_MASK                 0x00000007
  #define EFM32_CMU_PCNTCLKENMASK_PCNT0            0x00000001
  #define EFM32_CMU_PCNTCLKENMASK_PCNT1            0x00000002
  #define EFM32_CMU_PCNTCLKENMASK_PCNT2            0x00000004
