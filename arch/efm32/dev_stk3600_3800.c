...
DEV_DECLARE_STATIC_RESOURCES(usart1_dev_res, 8,
  ...
  DEV_STATIC_RES_IOMUX("clk",  /* LOC1 */ 1, /* PD2 */ 3*16+2, 0, 0),
  DEV_STATIC_RES_IOMUX("miso", /* LOC1 */ 1, /* PD1 */ 3*16+1, 0, 0),
  DEV_STATIC_RES_IOMUX("mosi", /* LOC1 */ 1, /* PD0 */ 3*16+0, 0, 0),
#if 0
  DEV_STATIC_RES_IOMUX("cs",   /* LOC1 */ 1, /* PD3 */ 3*16+3), */
#endif
