...
enum nrf51_clock_register {
    NRF51_CLOCK_HFCLKRUN = 2,
    NRF51_CLOCK_HFCLKSTAT = 3,
    NRF51_CLOCK_LFCLKRUN = 5,
    NRF51_CLOCK_LFCLKSTAT = 6,
    NRF51_CLOCK_LFCLKSRCCOPY = 7,
    NRF51_CLOCK_LFCLKSRC = 70,
    NRF51_CLOCK_CTIV = 78, // In .25s steps
    NRF51_CLOCK_XTALFREQ = 84,
};

#define NRF51_CLOCK_HF_SRC_MASK      0x1
#define NRF51_CLOCK_HF_SRC_RC        0x0
#define NRF51_CLOCK_HF_SRC_XTAL      0x1
#define NRF51_CLOCK_HFCLKSTAT_STATE_MASK    0x10000
#define NRF51_CLOCK_HFCLKSTAT_STATE_RUNNING 0x10000

#define NRF51_CLOCK_LF_SRC_MASK      0x3
#define NRF51_CLOCK_LF_SRC_RC        0x0
#define NRF51_CLOCK_LF_SRC_XTAL      0x1
#define NRF51_CLOCK_LF_SRC_SYNTH     0x2
