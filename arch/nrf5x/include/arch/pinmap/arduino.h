...
#ifndef ARCH_NRF5X_PINMAP_ARDUINO_H
#define ARCH_NRF5X_PINMAP_ARDUINO_H
...
#define PINMAP_ARDUINO_SCL  NRF_INO_PINOUT(SCL)
#define PINMAP_ARDUINO_SDA  NRF_INO_PINOUT(SDA)
#define PINMAP_ARDUINO_AREF NRF_INO_PINOUT(AREF)
#define PINMAP_ARDUINO_A0   NRF_INO_PINOUT(A0)
#define PINMAP_ARDUINO_A1   NRF_INO_PINOUT(A1)
#define PINMAP_ARDUINO_A2   NRF_INO_PINOUT(A2)
#define PINMAP_ARDUINO_A3   NRF_INO_PINOUT(A3)
#define PINMAP_ARDUINO_A4   NRF_INO_PINOUT(A4)
#define PINMAP_ARDUINO_A5   NRF_INO_PINOUT(A5)
#define PINMAP_ARDUINO_D0   NRF_INO_PINOUT(D0)
#define PINMAP_ARDUINO_D1   NRF_INO_PINOUT(D1)
#define PINMAP_ARDUINO_D2   NRF_INO_PINOUT(D2)
#define PINMAP_ARDUINO_D3   NRF_INO_PINOUT(D3)
#define PINMAP_ARDUINO_D4   NRF_INO_PINOUT(D4)
#define PINMAP_ARDUINO_D5   NRF_INO_PINOUT(D5)
#define PINMAP_ARDUINO_D6   NRF_INO_PINOUT(D6)
#define PINMAP_ARDUINO_D7   NRF_INO_PINOUT(D7)
#define PINMAP_ARDUINO_D8   NRF_INO_PINOUT(D8)
#define PINMAP_ARDUINO_D9   NRF_INO_PINOUT(D9)
#define PINMAP_ARDUINO_D10  NRF_INO_PINOUT(D10)
#define PINMAP_ARDUINO_D11  NRF_INO_PINOUT(D11)
#define PINMAP_ARDUINO_D12  NRF_INO_PINOUT(D12)
#define PINMAP_ARDUINO_D13  NRF_INO_PINOUT(D13)

#define PINMAP_ARDUINO_SS   NRF_INO_PINOUT(D10)
#define PINMAP_ARDUINO_MOSI NRF_INO_PINOUT(D11)
#define PINMAP_ARDUINO_MISO NRF_INO_PINOUT(D12)
#define PINMAP_ARDUINO_SCK  NRF_INO_PINOUT(D13)
