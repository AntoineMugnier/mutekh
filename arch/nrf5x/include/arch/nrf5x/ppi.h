...
enum nrf_ppi_hardwired_e {
  NRF_PPI_TIMER0_COMPARE_0_RADIO_TXEN    = 20,
  NRF_PPI_TIMER0_COMPARE_0_RADIO_RXEN    = 21,
  NRF_PPI_TIMER0_COMPARE_1_RADIO_DISABLE = 22,
  NRF_PPI_RADIO_BCMATCH_AAR_START        = 23,
  NRF_PPI_RADIO_READY_CCM_KSGEN          = 24,
  NRF_PPI_RADIO_ADDRESS_CCM_CRYPT        = 25,
  NRF_PPI_RADIO_ADDRESS_TIMER0_CAPTURE_1 = 26,
  NRF_PPI_RADIO_END_TIMER0_CAPTURE_2     = 27,
  NRF_PPI_RTC0_COMPARE_0_RADIO_TXEN      = 28,
  NRF_PPI_RTC0_COMPARE_0_RADIO_RXEN      = 29,
  NRF_PPI_RTC0_COMPARE_0_TIMER0_CLEAR    = 30,
  NRF_PPI_RTC0_COMPARE_0_TIMER0_START    = 31,
};
