...
enum nrf5x_uarte_register {
    NRF_UARTE_ERRORSRC = 32,
    NRF_UARTE_ENABLE = 64,
    NRF_UARTE_PSELRTS = 66,
    NRF_UARTE_PSELTXD = 67,
    NRF_UARTE_PSELCTS = 68,
    NRF_UARTE_PSELRXD = 69,
    NRF_UARTE_BAUDRATE = 73,
    NRF_UARTE_RXD_PTR = 77,
    NRF_UARTE_RXD_MAXCOUNT = 78,
    NRF_UARTE_RXD_AMOUNT = 79,
    NRF_UARTE_TXD_PTR = 81,
    NRF_UARTE_TXD_MAXCOUNT = 82,
...
#define NRF_UARTE_CONFIG_PARITY_MASK  0x6
#define NRF_UARTE_CONFIG_PARITY_DISABLED  0x0
#define NRF_UARTE_CONFIG_PARITY_ENABLED  0x6
