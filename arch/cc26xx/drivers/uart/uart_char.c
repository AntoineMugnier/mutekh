...
static void iomux_init(void)
{
  ...
  //DIO2 as UART0 RX
  reg = 0;
  CC26XX_IOC_IOCFG2_PORT_ID_SET(reg, UART0_RX);
  CC26XX_IOC_IOCFG2_PULL_CTL_SET(reg, DIS);
  reg |= CC26XX_IOC_IOCFG2_IE;
  cpu_mem_write_32(CC26XX_IOC_BASE + CC26XX_IOC_IOCFG2_ADDR, reg);
