...
/** @This is busy wait wrapper for the @ref dev_smi_request_t function */
BUSY_WAITING_FUNCTION
config_depend_inline(CONFIG_DEVICE_SMI,
error_t dev_smi_spin_request(
    const struct device_smi_s *accessor,
    struct dev_smi_rq_s *rq),
{
...
/** @This perform a @ref DEVICE_SMI_READ operation and wait for
    completion using a busy wait loop. */
BUSY_WAITING_FUNCTION
config_depend_inline(CONFIG_DEVICE_SMI,
error_t dev_smi_spin_read(
    const struct device_smi_s *accessor,
...
/** @This perform a @ref DEVICE_SMI_WRITE operation and wait for
    completion using a busy wait loop. */
BUSY_WAITING_FUNCTION
config_depend_inline(CONFIG_DEVICE_SMI,
error_t dev_smi_spin_write(
    const struct device_smi_s *accessor,
    uint8_t phy, uint8_t reg,
    uint16_t data),
{
