...
asm(
    ...
    ".globl nios2_interrupt_entry                               \n"
	".func nios2_interrupt_entry                                \n"
	".type nios2_interrupt_entry, %function                     \n"
...
/*	    "	rdctl   r1, ctl16                                       \n"*/
	    "	mov   r1, gp                                       \n"
    "   ldw     sp, __context_data_base(r1)                     \n"
#else
    "   movia   sp, __context_data_base                         \n"
#endif
    ...
    "	andi	r6, r4, 0x7c	    		                 	\n" /* test CAUSE field (bits 6 .. 2) */

    /*  read and save exception counter */

    "	addi    r7, zero, 12	    		                 	\n"  /* CAUSE = 3 - TRAP inst */
    "	beq     r4, r7, interrupt_sys	    		            \n"
...
/*	    "	rdctl   r1, ctl16                                       \n"*/
	    "	mov   r1, gp                                       \n"
    "   ldw     at, cpu_exception_handler(r1)                   \n"

#else
    "   movia    at, cpu_exception_handler                      \n"
#endif
    "   callr   at	    		        	                    \n"
    "	addi    sp, sp, 5*4	    		        	            \n"
...
/*	    "	rdctl   r1, ctl16                                       \n"*/
	    "	mov   r1, gp                                       \n"
    "   ldw     r1,    __context_data_base(r1)                  \n"
#else
    "   movia   r1,    __context_data_base	                    \n"
#endif
    "   ldw     at,     cpu_syscall_handler(r1)                 \n"
    "   callr   at	    		        	                    \n"
    "   addi    sp, sp, 4*4                                     \n"
...
/*	    "	rdctl   r1, ctl16                                       \n"*/
	    "	mov   r1, gp                                       \n"
    "	ldw     r1, cpu_interrupt_handler(r1)			        \n"
   /* "	ldw     r4, cpu_interrupt_handler_arg(r1)               \n"*/
#else
    "	movia   r1, cpu_interrupt_handler	    		        \n"
/*    "	movia   r4, cpu_interrupt_handler_arg	    		    \n"*/
#endif
...
"#end                                     \n"/* ALT_NO_INSTRUCTION_EMULATION */
    ...
    */
    "eret                                 \n"
	".endfunc                                        \n"
    ".size nios2_interrupt_entry, .-nios2_interrupt_entry \n"
