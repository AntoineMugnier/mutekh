...
#define __ATOMIC_ARM32M(type, width)                                    \
                                                                        \
inline type##_int_t                                                     \
...
__ATOMIC_ARM32M(atomic_fast16, "h");
...
__ATOMIC_ARM32M(atomic_fast8, "b");

#else

  /* v6m relies on hexo/atomic_cpu_nosmp.h */
